...
*/
VOID Spt_OnLButtonDown( HWND hWnd, BOOL fDoubleClick, [[maybe_unused]]INT_PTR x, [[maybe_unused]]INT_PTR y, [[maybe_unused]]UINT_PTR keyFlags )
{
...
/*!
	...
	@param[in]	keyFlags	押されてる他のボタン
*/
VOID Spt_OnMouseMove( HWND hWnd, [[maybe_unused]]INT_PTR x, [[maybe_unused]]INT_PTR y, [[maybe_unused]]UINT_PTR keyFlags )
{
	HWND	hPrWnd;
	RECT	stRect;
//	POINT	stPoint;
...
/*!
	...
	@param[in]	keyFlags	押されてる他のボタン
*/
VOID Spt_OnLButtonUp( HWND hWnd, INT_PTR x, INT_PTR y, [[maybe_unused]]UINT_PTR keyFlags )
{
	HWND	hPrWnd;
	RECT	stRect;
	//LONG	wWidth = 0;
