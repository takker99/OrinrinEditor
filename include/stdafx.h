...
#ifdef WIN32
    #ifdef _DEBUG
        #pragma comment(lib, "sqlite3-x86-debug.lib")
    #else
        #pragma comment(lib, "sqlite3-x86.lib")
    #endif
#else
    #ifdef _DEBUG
        #pragma comment(lib, "sqlite3-x64-debug.lib")
    #else
        #pragma comment(lib, "sqlite3-x64.lib")
    #endif
#endif
...
//-------------------------------------------------------------------------------------------------
	...
	VOID	OutputDebugStringPlus( DWORD, LPCTSTR, INT_PTR, LPCTSTR, LPCTSTR, ... );	//!<	
