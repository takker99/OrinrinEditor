if(Test-Path .\x64\Release\){
    ...
    Start-Process -FilePath "C:\Program Files\7-Zip\7z.exe" -ArgumentList "a .\OrinrinEditor-x64.zip .\OrinrinEditor-x64\"
}
...
if(Test-Path .\Release\){
    ...
    Start-Process -FilePath "C:\Program Files\7-Zip\7z.exe" -ArgumentList "a .\OrinrinEditor-x86.zip .\OrinrinEditor-x86\"
}